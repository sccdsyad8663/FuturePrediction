...
export async function updateDraft(draftId: number, payload: DraftPayload): Promise<DraftDetail> {
  await apiClient.put(`/v1/drafts/${draftId}`, payload)
  return getDraftById(draftId)
}
