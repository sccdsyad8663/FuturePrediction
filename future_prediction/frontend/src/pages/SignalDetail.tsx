...
export default function SignalDetail() {
  ...
  const canEdit = isAdmin && postDetail.author_id === userInfo.user_id
        ...
        <div className="col-span-9 bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden flex flex-col h-full">
           ...
           <div className="flex-1 overflow-y-auto p-8">
              ...
              {postDetail.k_line_image ? (
                <img src={postDetail.k_line_image} alt="K线图" className="w-full h-64 object-contain rounded-xl border-2 border-gray-200 mb-8" />
              ) : (
              ...
              <div className="flex gap-2">
                ...
                {canEdit && (
                  <button
                    ...
                    className="px-4 py-2 text-blue-600 border border-blue-200 hover:bg-blue-50 rounded-lg transition-colors text-sm"
                  >
                    编辑内容
                  </button>
                )}
                {isAdmin && (
                  <button
                    ...
                    className="px-4 py-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors text-sm border border-red-200 disabled:opacity-50"
                  >
